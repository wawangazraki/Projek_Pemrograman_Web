...
<div class="row mb-3">
    ...
    <div class="col-md-4 text-end">
        <a href="{{ route('kas-masuk.create') }}" class="btn btn-success">
                    ...
                    <tbody>
                        @foreach($transactions as $tx)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('kas-masuk.edit', $tx->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                    <form action="{{ route('kas-masuk.destroy', $tx->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
