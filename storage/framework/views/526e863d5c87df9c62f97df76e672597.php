...
<div class="row mb-3">
    ...
    <div class="col-md-4 text-end">
        <a href="<?php echo e(route('kas-masuk.create')); ?>" class="btn btn-success">
            <i class="fas fa-plus me-2"></i>Tambah Kas Masuk
        </a>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('kas-masuk.edit', $tx->id)); ?>" class="btn btn-sm btn-primary">Edit</a>
                                    <form action="<?php echo e(route('kas-masuk.destroy', $tx->id)); ?>" method="POST" style="display:inline;">
                                        <?php echo csrf_field(); ?>
        ...
        <?php else: ?>
            <p class="text-center text-muted py-4">Tidak ada data kas masuk</p>
        <?php endif; ?>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Apps\laragon\www\Project_Koperasi\resources\views/transactions/kas_masuk_index.blade.php ENDPATH**/ ?>